...
/**
 * Created by Robyn on 12/29/2016.
 */

public abstract class EndlessRVAnswerScrollListener extends RecyclerView.OnScrollListener {
    ...
    public EndlessRVAnswerScrollListener(LinearLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
    }

    public EndlessRVAnswerScrollListener(GridLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }

    public EndlessRVAnswerScrollListener(StaggeredGridLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }
...
//                            Log.i(mTag, "!!!!currentpage:" + currentPage);
                ...
                totalItemCount = (adapter.getItemViewType(totalItemCount -1) == PostQuestionAdapter.VIEW_TYPE_LOADING)
